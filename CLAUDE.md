...
Academic institutions get consistency in how their curricula are represented; students get an interactive visualization of their academic path through it. Reference material: `Context/Outline.pdf` (spec) and `Context/VisualMockups.pdf` (PennState-branded mockups).
